...
// Real-time dashboard fetch (unchanged)
...
function renderCharts(data) {
  ...
  totalChart = new Chart(ctx2, {
    type:'line',
    data:{ labels, datasets:[{ label:'Total Consumption (kWh)', data:totalE, borderColor:'rgba(153,102,255,1)', fill:false }]},
    options:{
      responsive:true,
